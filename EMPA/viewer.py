...
npz_path = ensure_file(NPZ_URL, "data/validationCaseEMPA.npz")
vtk_path = ensure_file(VTK_URL, "data/validationCaseEMPA.vtk")
...
with logo_col1:
    ...
    <div style='text-align: center; padding: 10px;'>
        <a href='https://heatwise.eu' target='_blank'>
            <img src='https://raw.githubusercontent.com/DSTECHNO/TDW/main/EMPA/heatwise_logo.svg' 
...
with logo_col2:
    ...
    <div style='text-align: center; padding: 10px;'>
        <a href='https://dstechs.net/' target='_blank'>
            <img src='https://raw.githubusercontent.com/DSTECHNO/TDW/main/EMPA/dstech_logo.png' 
